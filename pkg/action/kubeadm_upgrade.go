...
func KubeadmUpgradeApply(boot *cluster.Node, usePatch bool, wait time.Duration) (err error) {
...
func KubeadmUpgradeNode(node *cluster.Node, usePatch bool, wait time.Duration) (err error) {
	current := cluster.Current()
