...
var (
	...
	K8S_1_25_x, _ = NewRngVersion("v1.25.10", "v1.25.16")
	K8S_1_26_x, _ = NewRngVersion("v1.26.10", "v1.26.12")
	K8S_1_27_x, _ = NewRngVersion("v1.27.1", "v1.27.9")
	K8S_1_28_x, _ = NewRngVersion("v1.28.1", "v1.28.5")
