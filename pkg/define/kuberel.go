...
var (
	...
	K8S_1_24_x, _ = NewRngVersion("v1.24.10", "v1.24.17")
	K8S_1_25_x, _ = NewRngVersion("v1.25.1", "v1.25.16")
	K8S_1_26_x, _ = NewRngVersion("v1.26.1", "v1.26.11")
	K8S_1_27_x, _ = NewRngVersion("v1.27.1", "v1.27.8")
	K8S_1_28_x, _ = NewRngVersion("v1.28.1", "v1.28.4")
