...
var (
	...
	K8S_1_21_x, _ = NewRngVersion("v1.21.1", "v1.21.13")
	K8S_1_22_x, _ = NewRngVersion("v1.22.1", "v1.22.10")
	K8S_1_23_x, _ = NewRngVersion("v1.23.1", "v1.23.7")
	K8S_1_24_x, _ = NewRngVersion("v1.24.1", "v1.24.1")
