...
var (
	...
	K8S_1_25_x, _ = NewRngVersion("v1.25.1", "v1.25.13")
	K8S_1_26_x, _ = NewRngVersion("v1.26.1", "v1.26.8")
	K8S_1_27_x, _ = NewRngVersion("v1.27.1", "v1.27.5")
	K8S_1_28_x, _ = NewRngVersion("v1.28.1", "v1.28.1")
