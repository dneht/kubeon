...
var (
	...
	K8S_1_19_x, _ = NewRngVersion("v1.19.4", "v1.19.15")
	K8S_1_20_x, _ = NewRngVersion("v1.20.1", "v1.20.11")
	K8S_1_21_x, _ = NewRngVersion("v1.21.1", "v1.21.5")
	K8S_1_22_x, _ = NewRngVersion("v1.22.1", "v1.22.2")
